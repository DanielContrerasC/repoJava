...
//En programaci�n hay situaciones en las se necesitan cambiar el tipo de dato en otro.Para hacerlo
//		podemos usar cast es decir que tomamos un dato y lo trnasformamos en potro tipo de dato.
		//Se puede realizar el cast para todos los datos primitivos, con excepci�n de boolean, por la 
